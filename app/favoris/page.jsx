...
function FavorisContent() {
  ...
  return (
    <div className="max-w-[1380px] mx-auto px-4 sm:px-8 py-6 sm:py-8 space-y-4 sm:space-y-6 pb-[calc(6rem+env(safe-area-inset-bottom,0px))] md:pb-12 font-body text-[#454745]">
