...
/**
 * Create a new listing in Firestore. Always starts out 'pending' — it only
 * becomes publicly visible once an admin approves it in /dash.
 */
export async function createListing(listingData) {
  ...
  return { id: newDoc.id, ...listingData, sellerId: currentUid, status: 'pending' };
}
