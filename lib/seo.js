...
// Branded storefront-sign photo used as the default link-share thumbnail
// (and as the product/seller fallback when a listing has no photo).
export const DEFAULT_OG_IMAGE = `${SITE_URL}/images/tanitmarket-signage.jpg`;
